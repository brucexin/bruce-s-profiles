  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash python))
  (dictree--set-ordered-hash python ordered-hash))
(dictree--set-filename python (locate-library "python"))
(unless (memq python dictree-loaded-list) (push python dictree-loaded-list))
